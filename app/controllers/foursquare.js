...
getVenuesCityCat = function(city, category) {
	...
	var options = {
		...
		path: '/v2/venues/search?client_id=WUH3Z4VTUYMQCD54KHR0O2BBXXSCIBIQ31I2NX2VGNL2T4AF&client_secret=S0LD0WYY11CYTJQZ01EYBBL0SGNSLUN0RXRXJOJMO0Y540WU&v=20130815%20%20%20'
	};
...
isMorningActivity = function(id) {
	if(id == "4bf58dd8d48988d16a941735") //bakery
		return false;
...
isNoonActivity = function(id) {
	if(id == "4bf58dd8d48988d16a941735") //bakery
		return false;
	if(id == "4bf58dd8d48988d143941735") //breakfast
		return false;
};
